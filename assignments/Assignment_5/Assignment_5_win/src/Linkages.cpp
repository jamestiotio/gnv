...
void Linkages::InitLinkages(int caseID, vector<vector<float>> &verList, vector<vector<unsigned >> &triList)
{
    ...
    // init linkages
    if     (caseID == 1)      CrankRocker(width, thickness, depthM);
    else if(caseID == 2)      DragLink(width, thickness, depthM);
    else if(caseID == 3)      Hoecken(width, thickness, depthM); 
    else if(caseID == 4)      DoubleRocker(width, thickness, depthM);
...
//// TODO: fill this function to desgin Drag-Link
...
//// TODO: fill this function to desgin Hoecken
...
//// TODO: fill this function to desgin DoubleRocker
...
void Linkages::InitLMSolver()
{
    ...
    if(lmSlover.n > lmSlover.m) cout<< "lack constraints" <<endl;
    else if(lmSlover.n < lmSlover.m) cout<< "over constraints" <<endl;
